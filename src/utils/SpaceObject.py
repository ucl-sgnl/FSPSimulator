...
class SpaceObject:
    ...
    def prop_catobject(self, jd_start, jd_stop, step_size, output_freq, integrator_type, force_model, long_term_sgp4):
        ...
        if long_term_sgp4:
            numerical_segment_minutes = 10 # 30 mins of higher fidelity numerical propagation to fit the TLE to
            ...
            print("num ephem:", ephemeris_numerical)
            ...
            print("num ephem:", ephemeris_numerical[:5])
