...
def benchmark_simulation(simulation_specs):
    ...
    file_name = f'src/fspsim/data/specify_simulations/benchmarking_sims/{simulation_specs["scenario_name"]}.json'
...
def run_simulations_and_time(run_script_path):
    """Runs the simulate.py script and returns the time taken."""
...
def cleanup_simulation_files(simulation_specs_list):
    ...
    for specs in simulation_specs_list:
        file_name = f'src/fspsim/data/specify_simulations/benchmarking_sims/{specs["scenario_name"]}.json'
        if os.path.exists(file_name):
            os.remove(file_name)

def main():
    # Define the path to your simulate.py script
    run_script_path = 'src/fspsim/simulate.py'
    ...
    results.to_csv('src/fspsim/data/results/benchmark_results.csv', index=False)
