...
.. figure:: FSPSim_system_diag_v1.png
   ...
   Overview of FSPSim's architecture, showcasing how user inputs influence simulation parameters, the classes, and data sources they connect with, and the propagation mechanism.
...
.. figure:: fspsim_example.png
   :alt: A sample altitude time-series plot
   :align: center
   :width: 80%

   A sample altitude time-series plot generated from a simulation.
